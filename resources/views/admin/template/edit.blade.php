    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('template.update', $templates->id)}}" class="row g-3" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="position-relative input-icon">
                                <input type="text" name="name" class="form-control" id="input13" value="{{ old('name', $templates->name) }}">
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <img src="{{asset($templates->image)}}"  class="img-fluid" />
