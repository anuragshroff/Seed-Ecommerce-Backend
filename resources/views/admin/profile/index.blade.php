                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                @if(auth()->user()->image)
                                <img src="{{asset(auth()->user()->image)}}" alt="Admin" id="profileImagePreview" class="rounded-circle p-1 bg-primary" width="200">
                                @else
                                <img src="{{asset('assets/images/avatars/avatar-2.png')}}" alt="Admin" id="profileImagePreview" class="rounded-circle p-1 bg-primary" width="200">
                                @endif
                                <div class="mt-3">
                                    <h4>Personal Info</h4>
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <span class="text-secondary">{{auth()->user()->city}}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="tab-pane fade active show" id="primaryhome" role="tabpanel">
                                    ...
                                    <form class="row g-3" method="post" action="{{route('profileUpdate')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control" id="address" name="address" placeholder="Address ..." rows="3" >{{ old('address', auth()->user()->address) }}</textarea>
                                            @error('address')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
